...
*/
    ...
    public static void loadBanner(LinearLayout linearLayout, Activity activity) {
    ...
    public static void loadIndestrialads(final Context context) {
        mInterstitialAd = new InterstitialAd(context);
        mInterstitialAd.setAdUnitId(context.getString(R.string.g_inr));
